...
int REAPERAPI_LoadAPI(void *(*getAPI)(const char *))
{
  ...
  struct { void **dest; const char *name; } table[]={
    ...
    __RPFI(EnumProjectMarkers3) __RPFI(EnumProjects) __RPFI(EnumTrackMIDIProgramNames) __RPFI(EnumTrackMIDIProgramNamesEx) 
    __RPFI(file_exists) __RPFI(format_timestr) __RPFI(format_timestr_len) __RPFI(format_timestr_pos) 
    __RPFI(FreeHeapPtr) __RPFI(genGuid) __RPFI(get_config_var) __RPFI(get_ini_file) 
    __RPFI(get_midi_config_var) __RPFI(GetActionShortcutDesc) __RPFI(GetActiveTake) __RPFI(GetAppVersion) 
    __RPFI(GetAudioAccessorEndTime) __RPFI(GetAudioAccessorHash) __RPFI(GetAudioAccessorSamples) __RPFI(GetAudioAccessorStartTime) 
    __RPFI(GetColorTheme) __RPFI(GetColorThemeStruct) __RPFI(GetConfigWantsDock) __RPFI(GetContextMenu) 
    __RPFI(GetCurrentProjectInLoadSave) __RPFI(GetCursorContext) __RPFI(GetCursorPosition) __RPFI(GetCursorPositionEx) 
    __RPFI(GetDisplayedMediaItemColor) __RPFI(GetDisplayedMediaItemColor2) __RPFI(GetEnvelopeName) __RPFI(GetExePath) 
    __RPFI(GetExtState) __RPFI(GetFocusedFX) __RPFI(GetHZoomLevel) __RPFI(GetIconThemePointer) 
    __RPFI(GetIconThemeStruct) __RPFI(GetInputChannelName) __RPFI(GetItemEditingTime2) __RPFI(GetItemProjectContext) 
    __RPFI(GetLastTouchedFX) __RPFI(GetLastTouchedTrack) __RPFI(GetMainHwnd) __RPFI(GetMasterMuteSoloFlags) 
    __RPFI(GetMasterTrack) __RPFI(GetMasterTrackVisibility) __RPFI(GetMaxMidiInputs) __RPFI(GetMaxMidiOutputs) 
    __RPFI(GetMediaItem) __RPFI(GetMediaItem_Track) __RPFI(GetMediaItemInfo_Value) __RPFI(GetMediaItemNumTakes) 
    __RPFI(GetMediaItemTake) __RPFI(GetMediaItemTake_Item) __RPFI(GetMediaItemTake_Source) __RPFI(GetMediaItemTake_Track) 
    __RPFI(GetMediaItemTakeByGUID) __RPFI(GetMediaItemTakeInfo_Value) __RPFI(GetMediaItemTrack) __RPFI(GetMediaSourceFileName) 
    __RPFI(GetMediaSourceNumChannels) __RPFI(GetMediaSourceSampleRate) __RPFI(GetMediaSourceType) __RPFI(GetMediaTrackInfo_Value) 
    __RPFI(GetMidiInput) __RPFI(GetMIDIInputName) __RPFI(GetMidiOutput) __RPFI(GetMIDIOutputName) 
    __RPFI(GetMixerScroll) __RPFI(GetMouseModifier) __RPFI(GetNumAudioInputs) __RPFI(GetNumAudioOutputs) 
    __RPFI(GetNumMIDIInputs) __RPFI(GetNumMIDIOutputs) __RPFI(GetNumTracks) __RPFI(GetOutputChannelName) 
    __RPFI(GetOutputLatency) __RPFI(GetParentTrack) __RPFI(GetPeakFileName) __RPFI(GetPeaksBitmap) 
    __RPFI(GetPlayPosition) __RPFI(GetPlayPosition2) __RPFI(GetPlayPosition2Ex) __RPFI(GetPlayPositionEx) 
    __RPFI(GetPlayState) __RPFI(GetPlayStateEx) __RPFI(GetProjectPath) __RPFI(GetProjectPathEx) 
    __RPFI(GetProjectStateChangeCount) __RPFI(GetProjectTimeSignature) __RPFI(GetProjectTimeSignature2) __RPFI(GetResourcePath) 
    ...
    __RPFI(GetTake) __RPFI(GetTakeEnvelopeByName) __RPFI(GetTakeName) __RPFI(GetTCPFXParm) 
    __RPFI(GetTempoMatchPlayRate) __RPFI(GetTempoTimeSigMarker) __RPFI(GetToggleCommandState) __RPFI(GetToggleCommandState2) 
    __RPFI(GetTooltipWindow) __RPFI(GetTrack) __RPFI(GetTrackAutomationMode) __RPFI(GetTrackColor) 
    __RPFI(GetTrackDepth) __RPFI(GetTrackEnvelope) __RPFI(GetTrackEnvelopeByName) __RPFI(GetTrackGUID) 
    __RPFI(GetTrackInfo) __RPFI(GetTrackMediaItem) __RPFI(GetTrackMIDINoteName) __RPFI(GetTrackMIDINoteNameEx) 
    ...
    __RPFI(GetUserFileNameForRead) __RPFI(GetUserInputs) __RPFI(GR_SelectColor) __RPFI(GSC_mainwnd) 
    __RPFI(guidToString) __RPFI(HasExtState) __RPFI(HasTrackMIDIPrograms) __RPFI(HasTrackMIDIProgramsEx) 
    __RPFI(Help_Set) __RPFI(HiresPeaksFromSource) __RPFI(InsertMedia) __RPFI(InsertMediaSection) 
    __RPFI(InsertTrackAtIndex) __RPFI(IsInRealTimeAudio) __RPFI(IsItemTakeActiveForPlayback) __RPFI(IsMediaExtension) 
    __RPFI(IsMediaItemSelected) __RPFI(IsTrackSelected) __RPFI(IsTrackVisible) __RPFI(kbd_enumerateActions) 
    ...
    __RPFI(LICE_RoundRect) __RPFI(LICE_ScaledBlit) __RPFI(LICE_SimpleFill) __RPFI(Loop_OnArrow) 
    __RPFI(Main_OnCommand) __RPFI(Main_OnCommandEx) __RPFI(Main_openProject) __RPFI(Main_UpdateLoopInfo) 
    __RPFI(MarkProjectDirty) __RPFI(MarkTrackItemsDirty) __RPFI(Master_GetPlayRate) __RPFI(Master_GetPlayRateAtTime) 
    __RPFI(Master_GetTempo) __RPFI(Master_NormalizePlayRate) __RPFI(Master_NormalizeTempo) __RPFI(MB) 
    __RPFI(MediaItemDescendsFromTrack) __RPFI(MIDI_eventlist_Create) __RPFI(MIDI_eventlist_Destroy) __RPFI(midi_reinit) 
    __RPFI(MIDIEditor_GetActive) __RPFI(MIDIEditor_GetMode) __RPFI(MIDIEditor_GetTake) __RPFI(MIDIEditor_LastFocused_OnCommand) 
    ...
    __RPFI(screenset_register) __RPFI(screenset_registerNew) __RPFI(screenset_unregister) __RPFI(screenset_unregisterByParam) 
    __RPFI(SectionFromUniqueID) __RPFI(SelectAllMediaItems) __RPFI(SelectProjectInstance) __RPFI(SendLocalOscMessage) 
    __RPFI(SetActiveTake) __RPFI(SetAutomationMode) __RPFI(SetCurrentBPM) __RPFI(SetEditCurPos) 
    __RPFI(SetEditCurPos2) __RPFI(SetExtState) __RPFI(SetMasterTrackVisibility) __RPFI(SetMediaItemInfo_Value) 
    ...
    __RPFI(SetProjectMarker) __RPFI(SetProjectMarker2) __RPFI(SetProjectMarker3) __RPFI(SetRenderLastError) 
    __RPFI(SetTempoTimeSigMarker) __RPFI(SetTrackAutomationMode) __RPFI(SetTrackColor) __RPFI(SetTrackMIDINoteName) 
    __RPFI(SetTrackMIDINoteNameEx) __RPFI(SetTrackSelected) __RPFI(SetTrackSendUIPan) __RPFI(SetTrackSendUIVol) 
    __RPFI(ShowActionList) __RPFI(ShowConsoleMsg) __RPFI(ShowMessageBox) __RPFI(SLIDER2DB) 
    __RPFI(SnapToGrid) __RPFI(SoloAllTracks) __RPFI(SplitMediaItem) __RPFI(StopPreview) 
    __RPFI(StopTrackPreview) __RPFI(StopTrackPreview2) __RPFI(stringToGuid) __RPFI(TimeMap2_beatsToTime) 
    __RPFI(TimeMap2_GetDividedBpmAtTime) __RPFI(TimeMap2_GetNextChangeTime) __RPFI(TimeMap2_QNToTime) __RPFI(TimeMap2_timeToBeats) 
    __RPFI(TimeMap2_timeToQN) __RPFI(TimeMap_GetDividedBpmAtTime) __RPFI(TimeMap_GetTimeSigAtTime) __RPFI(TimeMap_QNToTime) 
    __RPFI(TimeMap_timeToQN) __RPFI(ToggleTrackSendUIMute) __RPFI(Track_GetPeakHoldDB) __RPFI(Track_GetPeakInfo) 
    __RPFI(TrackCtl_SetToolTip) __RPFI(TrackFX_EndParamEdit) __RPFI(TrackFX_FormatParamValue) __RPFI(TrackFX_FormatParamValueNormalized) 
    ...
    __RPFI(TrackFX_GetNumParams) __RPFI(TrackFX_GetOpen) __RPFI(TrackFX_GetParam) __RPFI(TrackFX_GetParameterStepSizes) 
    __RPFI(TrackFX_GetParamEx) __RPFI(TrackFX_GetParamName) __RPFI(TrackFX_GetParamNormalized) __RPFI(TrackFX_GetPreset) 
    __RPFI(TrackFX_GetPresetIndex) __RPFI(TrackFX_NavigatePresets) __RPFI(TrackFX_SetEnabled) __RPFI(TrackFX_SetEQBandEnabled) 
    __RPFI(TrackFX_SetEQParam) __RPFI(TrackFX_SetOpen) __RPFI(TrackFX_SetParam) __RPFI(TrackFX_SetParamNormalized) 
    __RPFI(TrackFX_SetPreset) __RPFI(TrackFX_SetPresetByIndex) __RPFI(TrackFX_Show) __RPFI(TrackList_AdjustWindows) 
    __RPFI(TrackList_UpdateAllExternalSurfaces) __RPFI(Undo_BeginBlock) __RPFI(Undo_BeginBlock2) __RPFI(Undo_CanRedo2) 
    __RPFI(Undo_CanUndo2) __RPFI(Undo_DoRedo2) __RPFI(Undo_DoUndo2) __RPFI(Undo_EndBlock) 
    __RPFI(Undo_EndBlock2) __RPFI(Undo_OnStateChange) __RPFI(Undo_OnStateChange2) __RPFI(Undo_OnStateChange_Item) 
    __RPFI(Undo_OnStateChangeEx) __RPFI(Undo_OnStateChangeEx2) __RPFI(UpdateArrange) __RPFI(UpdateItemInProject) 
    __RPFI(UpdateTimeline) __RPFI(ValidatePtr) __RPFI(ViewPrefs) __RPFI(WDL_VirtualWnd_ScaledBlitBG) 
    __RPFI(SNM_CreateFastString) __RPFI(SNM_DeleteFastString) __RPFI(SNM_GetFastString) __RPFI(SNM_GetFastStringLength) 
    __RPFI(SNM_SetFastString) __RPFI(SNM_GetMediaItemTakeByGUID) __RPFI(SNM_GetSourceType) __RPFI(SNM_GetSetSourceState) 
    __RPFI(SNM_GetSetSourceState2) __RPFI(SNM_GetSetObjectState) __RPFI(SNM_AddReceive) __RPFI(SNM_RemoveReceive) 
    __RPFI(SNM_RemoveReceivesFrom) __RPFI(SNM_GetIntConfigVar) __RPFI(SNM_SetIntConfigVar) __RPFI(SNM_GetDoubleConfigVar) 
    __RPFI(SNM_SetDoubleConfigVar) __RPFI(SNM_MoveOrRemoveTrackFX) __RPFI(SNM_GetProjectMarkerName) __RPFI(SNM_SetProjectMarker) 
    __RPFI(SNM_SelectResourceBookmark) __RPFI(SNM_TieResourceSlotActions) __RPFI(SNM_AddTCPFXParm) __RPFI(FNG_AllocMidiTake) 
    __RPFI(FNG_FreeMidiTake) __RPFI(FNG_CountMidiNotes) __RPFI(FNG_GetMidiNote) __RPFI(FNG_GetMidiNoteIntProperty) 
    __RPFI(FNG_SetMidiNoteIntProperty) __RPFI(FNG_AddMidiNote) 
  };
  int i,failcnt=0;
