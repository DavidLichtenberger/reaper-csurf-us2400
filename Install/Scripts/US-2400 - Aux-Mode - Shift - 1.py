...
###############################################################################
##
## US2400 - Aux-Mode - Shift - 1
##
## Custom action for Shift + 1 on the US-2400 in Aux Mode
##
...
## REMOVE SEND TO AUX---1 FROM SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux Shift 1: Remove Aux 1")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Remove 'aux---1' send from selected tracks", 0)