...
###############################################################################
##
## US2400 - Aux-Mode - FKey - 4
##
## Custom action for FKey + 4 on the US-2400 in Aux Mode
##
...
## ADD SEND TO AUX---4 TO SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux F 4: Add Aux 4")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Add 'aux---4' send to selected tracks", 0)