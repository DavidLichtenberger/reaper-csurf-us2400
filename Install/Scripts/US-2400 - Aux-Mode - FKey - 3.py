...
###############################################################################
##
## US2400 - Aux-Mode - FKey - 3
##
## Custom action for FKey + 3 on the US-2400 in Aux Mode
##
...
## ADD SEND TO AUX---3 TO SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux F 3: Add Aux 3")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Add 'aux---3' send to selected tracks", 0)			