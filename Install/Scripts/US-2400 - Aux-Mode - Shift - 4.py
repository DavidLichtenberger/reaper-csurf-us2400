...
###############################################################################
##
## US2400 - Aux-Mode - Shift - 4
##
## Custom action for Shift + 4 on the US-2400 in Aux Mode
##
...
## REMOVE SEND TO AUX---4 FROM SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux Shift 4: Remove Aux 4")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Remove 'aux---4' send from selected tracks", 0)