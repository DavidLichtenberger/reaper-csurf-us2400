...
###############################################################################
##
## US2400 - Aux-Mode - Shift - 5
##
## Custom action for Shift + 5 on the US-2400 in Aux Mode
##
...
## REMOVE SEND TO AUX---5 FROM SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux Shift 5: Remove Aux 5")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Remove 'aux---5' send from selected tracks", 0)