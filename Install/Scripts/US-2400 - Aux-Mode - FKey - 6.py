...
###############################################################################
##
## US2400 - Aux-Mode - FKey - 6
##
## Custom action for FKey + 6 on the US-2400 in Aux Mode
##
...
## ADD SEND TO AUX---6 TO SELECTED TRACKS


from reaper_python import *
from sws_python import *

# RPR_ShowConsoleMsg("Aux F 6: Add Aux 6")
...
if (RPR_CountSelectedTracks(0) > 0):
	...
	RPR_Undo_EndBlock("Add 'aux---6' send to selected tracks", 0)			